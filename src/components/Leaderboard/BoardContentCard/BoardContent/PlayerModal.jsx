      ...
      {isModalVisible && (
        ...
        >
          <Modal
            ...
            className="top-[calc(50%-200px)] left-[calc(50%-165px)]"
          >
            <motion.div
              className="flex"
              ...
              <div className="flex">
                <div className="w-[300px] h-[400px] bg-dark-black border-gray-800 border-[2px] p-5 grid grid-rows-2">
                  ...
                  <div className="bg-[#050D1680] p-5 rounded-md grid grid-rows-6 tracking-wide">
                    ...
                    <p className="text-sm my-auto row-start-3">
                      Level: {player.level}
                    </p>
                    <p className="text-xl my-auto mt-3 font-[700] row-start-5 row-span-2 tracking-wider">
                      TID:#{player.tid}
                    </p>
                  </div>
                </div>
                <AnimatePresence>
                  {isExpanded && (
                    <motion.div
                      ...
                      animate={{ width: "400px" }}
                      exit={{ width: 0 }}
                      className=" bg-dark-black flex justify-center items-center"
                    >
