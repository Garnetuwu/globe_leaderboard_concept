...
const Navbar = () => {
    return (
        <nav className={`w-screen bg-[#03060D] flex justify-between p-[15px] h-[60px] text-sm whitespace-nowrap`}>
            <CommonNav />
            <PersonalNav />
        </nav>
    )
...
const CommonNav = () => {
    return <div className='flex-1 flex justify-between'>
        <div className='flex gap-8 items-center'>
            <Link to='/' className='text-xl font-bold'> DEMO </Link>
            ...
            <form action='/' className='bg-[#17191F] rounded-[3px] border-[1px] border-[#2F3139] h-[36px] w-[214px] flex items-center'>
        ...
        <div className='flex items-center ml-5 gap-[30px] pr-[30px]'>
...
const PersonalNav = () => {
    return <ul className='flex items-center'>
        <li className='personalNav relative hide'>
